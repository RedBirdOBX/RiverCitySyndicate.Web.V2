    ...
    var $window = $(window);
        ...
        $window.on('scroll', function() {
            ...
            if (scroll <= 50) {
                ...
                logoinner.attr('src', 'assets/imgs/logos/header-logo-2.png');
                logodefault.attr('src', 'assets/imgs/logos/logo.png');
                logowhite.attr('src', 'assets/imgs/logos/logo-white.png');
                logowhitedark.attr('src', 'assets/imgs/logos/logo-white.png');
                logo2.attr('src', 'assets/imgs/logos/logo-2-light.png');
                logo3.attr('src', 'assets/imgs/logos/logo-2-dark.png');
                logo4.attr('src', 'assets/imgs/logos/logo-5-dark.png');
                logo5.attr('src', 'assets/imgs/logos/logo-3-light.png');
                logo6.attr('src', 'assets/imgs/logos/logo-4-light.png');
                logo7.attr('src', 'assets/imgs/logos/logo-6-dark.png');
            }
            else {
                $("header").removeClass("fixedHeader").addClass("scrollHeader");
                logoinner.attr('src', 'assets/imgs/logos/header-logo-top-fixed.png');
                logodefault.attr('src', 'assets/imgs/logos/header-logo-top-fixed.png');
                logowhite.attr('src', 'assets/imgs/logos/logo-white.png');
                logowhitedark.attr('src', 'assets/imgs/logos/logo-dark.png');
                logo2.attr('src', 'assets/imgs/logos/logo-2-dark.png');
                logo3.attr('src', 'assets/imgs/logos/logo-2-dark.png');
                logo4.attr('src', 'assets/imgs/logos/logo-5-dark.png');
                logo5.attr('src', 'assets/imgs/logos/logo-3-dark.png');
                logo6.attr('src', 'assets/imgs/logos/logo-4-dark.png');
                logo7.attr('src', 'assets/imgs/logos/logo-6-dark.png');
            }
        });
        ...
        {
            //alert("calling SetResizeContent");
